class User < ApplicationRecord
  ...
  belongs_to :barbershop, inverse_of: :users
  accepts_nested_attributes_for :barbershop, reject_if: proc { |attr| attr['barbershop_name'].blank? || attr['bio'].blank? || attr['price'].blank? }
  has_secure_password
